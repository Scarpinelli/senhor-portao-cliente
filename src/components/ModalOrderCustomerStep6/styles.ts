...
export const DescriptionImage = styled.ImageBackground<StyledProps>`
    width: ${(props: any) => props.size ? `${props.size}px` : '60px'};
    height: ${(props: any) => props.size ? `${props.size}px` : '60px'};
    border-radius: ${(props: any) => props.size ? `${props.size}px` : '10px'};
    overflow: hidden;
`;

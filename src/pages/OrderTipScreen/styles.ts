...
export const ValuesButton = styled.TouchableOpacity<StyledProps>`
    border-width: 1px;
    border-color: ${props => props.active ? Colors.success:  `${Colors.muted}20` };
    background: ${props => props.active ? Colors.success:  `${Colors.muted}20` };
    height: 40px;
    flex: 1;
    flex-grow: 1;
    border-radius: 4px;

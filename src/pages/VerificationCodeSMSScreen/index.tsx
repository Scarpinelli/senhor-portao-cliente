...
const VerificationCodeSMSScreen: React.FC = ({ navigation }: any) => {
    const { setUser, logout, resolveError, getUser } = useContext(DataContext)
    ...
    const { errors, handleSubmit, getFieldProps, isValid, setFieldValue } =
        useFormik({
            ...
            onSubmit: async (_values, { setSubmitting }) => {
                ...
                try {
                    const data = await Endpoints.verifyMailCode({
                        input1: _values?.input1,
                        input2: _values?.input2,
                        input3: _values?.input3,
                        input4: _values?.input4,
                        input5: _values?.input5,
                    })
    ...
    const resendCode = async () => {
        setLoader(true)
        try {
            const data = await Endpoints.sendSMSCode()
            ...
            <Container>
                <SafeAreaView style={{ flex: 1 }}>
                    <Top>
                        ...
                        <CText mb6 center>
                            {/* Magna adipisicing cillum velit voluptate nulla
                            ullamco nulla. Sunt id non sunt commodo
                            reprehenderit dolore pariatur sint aliqua ut */}
                        </CText>
...
export default VerificationCodeSMSScreen

...
export const LabelStep = styled.View`
    /* position: absolute; */
    /* top: 50px; */
    /* right: 30px; */
    background: #ff0000;
...
export const OnlineBadge = styled.View<StyledProps>`
...
export const AlertContent = styled.View<StyledProps>`
    background: ${props => props.bg ? props.bg : '#F5A524'} ;
    padding: 10px 20px;
    border-radius: 30px;
    flex-direction: row;
    align-items: center;
...
export const TopAlertsContainer = styled.View`
    margin-top: 20px;
`;